  ...
  return (
     <div className=" h-5/6  flex items-center justify-center white">
        ...
        <div className="w-96 h-52 bg-black/40 text-white flex items-center justify-center text-5xl flex-col font-black rounded-lg">
          Fake Store
          <NavLink to="/shop" className="bg-white/20 mt-8 text-orange-300 text-center text-2xl border-solid border-orange-300 w-32 border-4 rounded-lg hover:bg-white ">
            Shop
          </NavLink>
        </div>
     </div>
